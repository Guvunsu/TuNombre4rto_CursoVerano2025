...
using SotomaYorch.Mechanics.Effects;
...
namespace SotomaYorch.Mechanics.Causes
{
    ...
    public class OnHurtBoxCause : OnTriggerCause
    {
        #region UnityEvents
        ...
        protected void CheckForHurtEvent(GameObject other)
        {
            ...
            {
                if (_healthManager != null && other.gameObject.GetComponent<HitBoxEffect>() != null)
                {
                    _healthManager.ReduceHealth(other.gameObject.GetComponent<HitBoxEffect>().damagePerHit);
